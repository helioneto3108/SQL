...
select count(paid_date) as qtde_pagamentos
...
select count(distinct paid_date) as dias_pagamentos

from sales.funnel

where visit_page_date between '2021-01-01' and '2021-01-30'
